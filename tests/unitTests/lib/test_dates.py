...
class Test_Dates(unittest.TestCase):
	...
	def test_getDateTimeFromString(self):
		...
		tests = ["0503", "20060503", "2006-05-03", "060503"]
		expected_date = datetime.datetime(year, 5, 3, 12, 15, 00)
	...
	def test_goDate(self):
		...
		self.assertEqual(dates.goDate(datetime.datetime(2006, 5, 3, 12, 15, 00), 10), datetime.datetime(2006, 5, 13, 12, 15, 00))
		...
		self.assertEqual(dates.goDate(datetime.datetime(2006, 5, 3, 12, 15, 00), -2), datetime.datetime(2006, 5, 1, 12, 15, 00))
